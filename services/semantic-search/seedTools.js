...
const sampleTools = [
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      "The modern web developer's platform. Complete framework for building mobile and desktop web applications.",
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Fast, unopinionated, minimalist web framework for Node.js. Build web applications and APIs.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Fast and low overhead web framework, for Node.js. Highly performant with built-in validation.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'A utility-first CSS framework for rapidly building custom designs. Low-level CSS.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'The most popular HTML, CSS, and JavaScript framework for developing responsive projects.',
    keywords: [
      'bootstrap',
      'css',
      'style',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      "MUI Core: Ready-to-use foundational React components. Implement Google's Material Design.",
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'A production-ready motion library for React. Declarative animations and gestures.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Professional-grade JavaScript animation for the modern web. GreenSock Animation Platform.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Redefined chart library built with React and D3. Composable React components for charts.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Data-Driven Documents. JavaScript library for producing dynamic, interactive data visualizations.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      '2kB JavaScript date utility library. Immutable date library alternative to Moment.js.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Modern JavaScript date utility library. Modular, functional, works with webpack and Browserify.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'A library to help you hash passwords. Blowfish cipher with slow hashing for security.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Node.js CORS middleware. Enable Cross-Origin Resource Sharing in Express/Connect.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Help secure Express apps with various HTTP headers. Security middleware collection.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'HTTP request logger middleware for node.js. Log HTTP requests in various formats.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Simple monitor script for use during development of a Node.js app. Auto-restart on changes.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Cross-platform setting of environment scripts. Set env vars across Windows and Unix.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'A collection of common interactive command line user interfaces. Interactive prompts.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Human-friendly and powerful HTTP request library for Node.js. Simplified HTTP requests.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Realtime application framework. Enables real-time bidirectional event-based communication.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'A query language for your API. Query exactly what you need, get predictable results.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Spec-compliant and production ready JavaScript GraphQL server. GraphQL server for Node.js.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Redis client for Node.js. High performance Redis client with async/await support.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'High performance Node.js image processing. Resize, convert, and manipulate images.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'An image processing library written entirely in JavaScript for Node. Zero native dependencies.',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Cross-browser automation library. Reliable end-to-end testing for modern web apps.',
    keywords: [
      'playwright',
      'browser',
      'automation',
  ...
  },
  {
    ...
    platform: 'npm',
    description:
      'Fast, easy and reliable testing for anything that runs in a browser. End-to-end testing.',
